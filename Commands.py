...
class Commands:
    ...
    def __init__(self, client):
        self._GLOBAL_DELAY: float = 0.08

        self._client: Client = client
        self.duties: Duties = Duties()

        timetable = requests.get("https://lyceum.nstu.ru/rasp/nika_data_09102021_162042.js", verify=False).text. \
            replace(
    ...
    async def ShowTimetable(self, message: filters.Message):
        ...
        return await self._client.send_message(message.chat.id, result,
                                               reply_markup=InlineKeyboardMarkup(
                                                   [[InlineKeyboardButton(f"{dayNames[h+w]}", callback_data=f"{h+w}")
